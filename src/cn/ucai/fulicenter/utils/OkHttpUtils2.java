...
public class OkHttpUtils2<T> {
    ...
    private void initHandler() {
        mHandler = new Handler(fulicenter.applicationContext.getMainLooper()) {
            @Override
...
//url=http://10.0.2.2:8080/SuperWeChatServer/Server?request=server_status
    public OkHttpUtils2<T> setRequestUrl(String request) {
        mUrl = new StringBuilder(I.SERVER_ROOT);
        mUrl.append(I.QUESTION)
